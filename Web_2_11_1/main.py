...
from src.schemas import CatResponse, OwnerModel, OwnerResponse, CatModel, CatVaccinatedModel
app = FastAPI()
...
@app.patch("/cats/{cat_id}/vaccinated", response_model = CatVaccinatedModel, tags = ['cats'])
